...
data_dir <- file.path("experiments", "normalizing flow", "miniboone")
train <- read.csv(file.path(data_dir, "miniboone_train.csv"))
val   <- read.csv(file.path(data_dir, "miniboone_val.csv"))
test  <- read.csv(file.path(data_dir, "miniboone_test.csv"))
