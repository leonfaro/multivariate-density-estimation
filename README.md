...
## Installation (Ubuntu)
To run the R scripts in this repository, a working R installation with additional packages is required. Install the base system and the required packages via
